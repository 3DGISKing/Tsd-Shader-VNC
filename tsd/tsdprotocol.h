...
#define Packet_StartSessonRequest       22
#define Packet_StartSessonRefuse        23
#define Packet_StartSessonAgree         24
#define Packet_StopSessonRequest        25
#define Packet_DeleteSessonRequest      26
...
typedef struct tagStopSessionPacket
{
	int  type;
